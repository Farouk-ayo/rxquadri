export const experienceData: ExperienceProps[] = [
  {
    ...
    title: "Project Lead",
    company: "PharmaEco (formerly PharmaBin)",
    ...
    responsibilities: [
      ...
      `Built the company’s official website <a href="https://www.pharmaeco.org/" target="_blank" rel="noopener noreferrer" class="text-orange-500  underline">(Live Website)</a> and digital interface, setting design guidelines and usability standards that ensure accessibility, sustainability, and scalability.`,
